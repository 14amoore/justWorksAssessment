...
(async () => {
  ...
  const cryptoSplit = await cryptoDistribution(amountToInvest);
  if (cryptoSplit) {
    console.log(
      `You should buy ${cryptoSplit.Bitcoin} of BTC, and ${cryptoSplit.Ethereum} of ETH to maintain a 70/30 split of the $${amountToInvest} you have to invest.`
    );
  } else {
